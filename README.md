...
On each click the app makes a GET request to the backend.  This output is suppressed in normal usage, use the “INFO” verbosity setting to see each request:

![normal requests](https://i.imgur.com/FmrdhgA.png)
...
If the “mifkad.exe” process is terminated, the app will display the following message after attempting to register a click:

![error](https://i.imgur.com/r5AYK5M.png)
...
The extended day configuration is calculated at runtime (and on each click), and can be reconfigured using the UI found at the bottom of the page:

![extended config](https://i.imgur.com/IMQ35mc.png)
